...
import {
  ...
  deleteAccountPermanently, exportPersonalData, handleRegister, handleVerify, handleLogin, saveProfile, setStatus,
...
<template>
  <section v-if="!isAuthenticated" class="grid-two">
    ...
    <article class="card">
      ...
      <template v-if="isDev && !resetPasswordToken && !showForgotPasswordForm">
