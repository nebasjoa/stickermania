...
ALTER TABLE wc_games ADD COLUMN IF NOT EXISTS actual_home TINYINT UNSIGNED NULL;
ALTER TABLE wc_games ADD COLUMN IF NOT EXISTS actual_away TINYINT UNSIGNED NULL;
